 ...
 * @date Created in 22/06/2021 21:39
 */
...
public class RedisKeyUtil {
     ...
     */
    private static final String RESET_PWD_TOKEN_KEY = "sisphus:restPwd";
    private static final String ACTIVE_USER = "sisphus:activeUser";
    private static final String SEND_SMS_COUNT = "sisphus:sms:count";
    private static final String SEND_EMAIL_CODE = "sisphus:email:code";
    private static final String ACCESS_TOKEN = "sisphus:token:accessToken";
    private static final String UPLOAD_FILE_SIZE = "sisphus:file:upload_file_size";
